...
async def main(request: Request):
    ...
    port = 3306
    food_choice = FoodChoice(db_name, user, password, host, port)

    ran_side_name = food_choice.ran_side()
    ran_soup_name = food_choice.ran_soup()

    food_choice.close_connection()
